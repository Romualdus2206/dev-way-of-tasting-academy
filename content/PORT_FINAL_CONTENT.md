...
## Port Track V2 — Final Content
### 45 lessen · 9 modules · unieke slugs

**Versie:** V2 Final Content (leidende versie, locked)
**Bron:** `archive/intermediate/PORT_TRACK_V2_PERFECT.md` → `python3 scripts/polish_port_track_v2_gold_master.py`
...
B. Bruine tint en noten door houtlagering ✅
...
D. Lage opbrengst voorkomt houtlagering
...
A. Meer suiker
B. Oxidatie tijdens houtlagering ✅
C. Minder alcohol
D. Witte druiven
...
Goed. Je begrijpt nu hoe houtlagering en oxidatie Tawny zachter, amberkleuriger en complexer maken dan Ruby — en wat leeftijdsaanduiding werkelijk betekent.
...
Sterk. Je snapt nu hoe LBV met extra houtlagering de brug slaat tussen toegankelijke Ruby en prestigieuze Vintage Port.
...
Sterk. Je begrijpt nu waarom Tawny en notendesserts via oxidatie logisch aan elkaar vastzitten — en waarom Ruby hier zelden de beste keuze is.
...
Goed. Je ziet nu waarom Port bij vlees selectief werkt — en hoe reductie en wildpairing de sterkste toepassingen zijn.
