# COCK_REPAIR_APEROL_SPRITZ.md

> **Status:** samengevoegd in [`COCK_MODULES.md`](COCK_MODULES.md) als **LES 38 — Aperol Spritz als aperitief** (Module 8).  
> Dit bestand blijft als ontwerp-/repair-notitie; de canonieke bron is `COCK_MODULES.md`.

# Way of Tasting Academy
## Cocktail Track Repair
### Toevoeging binnen Module 8 — Pairing & Gastronomie

Doel:
De Advies-tab genereert weersafhankelijke cocktailsuggesties.

Aperol Spritz wordt frequent geadviseerd bij:
- warm weer
- zonnig weer
- aperitiefmoment
- lichte pairingmomenten

Probleem:
Aperol Spritz ontbreekt momenteel in de Academy-routing.

Oplossing:
Toevoegen als nieuwe les binnen Module 8.
...
Niet klassieke structuren:
de educatieve waarde zit vooral in:
...
Daarom past deze les logisch binnen:

Module 8 — Pairing & Gastronomie

---

# LES 37 — Aperol Spritz als aperitief
...
Perfect. Je begrijpt nu waarom Aperol Spritz hét voorbeeld is van moderne aperitiefcultuur.
