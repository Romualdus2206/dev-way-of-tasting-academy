...
## White Wine Track V2 — Final Content
### 40 lessen · 9 modules · unieke slugs

**Versie:** V2 Final Content (leidende versie)
**Bron:** `pipeline/WHITE_PIPELINE_CONTENT.md` → `python3 scripts/polish_white_gold_master_locked.py`
...
**Module goal:** In deze module ontdek je wat witte wijn is, hoe het ontstaat, waarom het uniek is en welke belangrijkste stijlen er zijn.
...
# LES 1 — Wat is witte wijn?

## Metadata

**Slug:** wat-is-witte-wijn
**Duration:** 8 min
**Quiz questions:** 5
...
Witte wijn wordt meestal gemaakt met:
...
Wat is belangrijk in witte wijn?
...
Witte wijn kan ook van blauwe druiven worden gemaakt:
...
Waar komt de kleur meestal vandaan?
...
Sterk. Je begrijpt nu waarom witte wijn zijn identiteit ontleent aan schilcontact, niet aan de druif zelf.
...
In de volgende les ga je een stap dieper: hoe oogsttiming en débourbage die zuurruggengraat al vóór de gisting beschermen.
...
Goed gedaan. Je ziet nu hoe elke stap in de keten — van oogst tot élevage — bewust fruit en zuur beschermt.
...
In les 3 zoom je uit en ontdek je waarom zuur — het resultaat van precies deze keten — witte wijn tot de meest veelzijdige categorie aan tafel maakt.
...
**Slug:** waarom-is-witte-wijn-uniek
**Duration:** 8 min
**Quiz questions:** 5
...
Wat maakt witte wijn vaak uniek?
...
Wat bepaalt witte wijnstijl sterk?
...
Waarom is witte wijn gastronomisch sterk?
...
Wat geeft spanning in witte wijn?
...
Sterk. Je begrijpt nu waarom één structuurelement — zuur — het volledige witte spectrum draagbaar houdt.
...
In les 4 leer je hoe deze zuurgedreven identiteit historisch pas recent — met de komst van temperatuurcontrole — tot volle wasdom kwam.
...
Wie maakten al vroeg witte wijn?
...
Welke regio is historisch belangrijk?
...
Welke druif geldt als zeer oud?
...
Wat verbeterde witte wijnkwaliteit sterk?

A. Temperatuurcontrole ✅
B. Fortificatie
C. Distillatie
D. Carbonatie
...
Wanneer explodeerde de kwaliteit sterk?
...
Goed. Je kunt nu uitleggen waarom de frisse, strakke witte wijn van vandaag technisch gezien jong is, ondanks eeuwenoude wijngaarden.
...
In les 5 gebruik je die technische lens om de vijf hoofdcategorieën binnen witte wijn te herkennen.
...
---
# LES 5 — Belangrijkste witte wijncategorieën

## Metadata

**Slug:** witte-wijncategorieen
**Duration:** 8 min
**Quiz questions:** 5
...
Welke stijl is meestal het meest fris?
...
Welke stijl is sterk aromatisch?
...
Sterk. Je herkent nu de vijf hoofdcategorieën als resultaat van meetbare keuzes, niet van smaak alleen.

Drie leerankers:
- terpenen voor de directe, bloemige aromatiek van aromatische rassen
- thiolen voor de citrus- en kruidentonen van Sauvignon Blanc-achtige stijlen
- edelrot en passerillage als twee losstaande routes naar zoete witte wijn

Module 2 begint in les 6 bij het allereerste productiemoment: direct press, waar de basis voor elke categorie letterlijk wordt geperst.
...
**Module goal:** In deze module leer je hoe productiekeuzes de stijl, structuur en kwaliteit van witte wijn bepalen.
...
A. Meer tannine
B. Minder schilinvloed ✅
C. Meer alcohol
D. Meer kleur

### Vraag 2

Wat blijft beter behouden?
...
Goed. Je begrijpt nu waarom persfractie net zo bepalend is voor kwaliteit als druif of terroir.
...
In les 7 volg je het sap de tank in en ontdek je hoe temperatuur tijdens de gisting dat kwetsbare aroma verder beschermt of juist verliest.
...
Wat ontstaat tijdens fermentatie?
...
Te warme fermentatie geeft vaak:
...
Sterk. Je kunt nu reductie uit een koude gisting onderscheiden van een structurele wijnfout.
...
In les 8 verlaat de wijn de tank en kijk je naar de volgende beslissing: RVS of hout, en wat dat werkelijk met textuur doet.
...
Welke druif wordt vaak op hout opgevoed?
...
Goed. Je weet nu dat vatkeuze via micro-oxygenatie werkt, niet simpelweg via 'smaak toevoegen'.

Drie leerankers:
- micro-oxygenatie als mechanisme achter houtrijping
- vatformaat (barrique versus foudre) als bepalende factor voor houtintensiteit
- bâtonnage en betonei als textuurbron zonder houtsmaak

In les 9 draait de volgende stijlkeuze niet om het vat maar om een bacterie: malolactische gisting.
...
Bij welke druif wordt MLF vaak gebruikt?
...
Sterk. Je begrijpt nu waarom MLF een bewuste stijlkeuze is en geen automatisch onderdeel van witte wijnproductie.
...
In les 10 zie je hoe die zuurbeslissing samen met rijpingskeuzes bepaalt hoe een witte wijn over jaren evolueert.
...
---
# LES 10 — Rijping van witte wijn

## Metadata

**Slug:** rijping-witte-wijn
**Duration:** 8 min
**Quiz questions:** 5
...
Goed gedaan. Je kunt nu onderbouwen welke witte wijnen daadwerkelijk baat hebben bij verder liggen.
...
Met dit fundament stap je in les 11 de proefzaal in: hoe je witte wijn systematisch en reproduceerbaar proeft.
...
**Module goal:** In deze module leer je hoe je witte wijn professioneel proeft, analyseert en beoordeelt.
...
Sterk. Je beheerst nu het aangepaste proefprotocol waarin zuur de rol van tannine overneemt.
...
In les 12 pas je dit protocol concreet toe op het eerste zintuig: kleur.
...
Welke kleur past vaak bij jonge witte wijn?
...
Welke wijn is vaak licht van kleur?
...
Goed. Je gebruikt kleur nu als hypothese in plaats van als eindoordeel.

Drie leerankers:
- kleur als lineaire as (bleekgeel-groen tot amber) in plaats van rand-versus-kern
- diepgoud als optelsom van rijpheid, hout, MLF en lees-contact
- amber als gevoeligste signaal tussen stijl, rijping en fout

In les 13 zet je die visuele hypothese om in een aromahypothese: hoe herken je primair, secundair en tertiair fruit?
...
Je ruikt een oudere witte wijn met een duidelijke petrolgeur naast citrus. Welke druif en welk aromatype past hier het beste bij?
...
Sterk. Je kunt nu aroma's indelen naar herkomst in plaats van naar losse woorden.

Drie leerankers:
- primair fruit als klimaatsignaal (citrus/groen versus steenfruit/tropisch)
- secundaire aroma's (boter, brooddeeg, gist) uit lees-contact en MLF
- tertiaire aroma's die per druif sterk verschillen, zoals petrol bij Riesling

In les 14 volgt het laatste zintuiglijke bouwblok vóór de mini-toets: zuur zelf, in detail.
...
Welke druif heeft vaak hoge zuren?
...
Een witte wijn heeft een opvallend ronde, zachte zuurindruk zonder scherpe randjes, terwijl het label een koel klimaat vermeldt. Wat is de meest logische verklaring?
...
Goed. Je kunt nu zuur objectief beoordelen los van klimaat- en productiesignalen door elkaar te halen.
...
In les 15 breng je kleur, aroma en zuur samen in de eerste grote integratietoets van deze track.
...
Een witte wijn wordt direct na de oogst geperst, waarbij het sap vrijwel meteen van de schillen wordt gescheiden. Welk structuurelement wordt hierdoor het minst beïnvloed door de druif zelf?
...
Je proeft een bleekgele wijn met een lichte groene gloed, hoog zuur en weinig geur van boter of toast. Welke hypothese past het beste?
...
Je ruikt brooddeeg, boter en een lichte vanilletoon naast rijp appelfruit. Welke twee lagen proef je hier samen?
...
Een wijnmaker past volledige malolactische gisting toe op een Chardonnay. Wat is het meest directe effect op de zuurstructuur?
...
Je proeft een oudere witte wijn met een duidelijke petrolgeur naast limoen. In welke laag hoort deze petrolgeur, en welke druif past hier het meest voor de hand liggend bij?
...
Twee wijnen van dezelfde druif verschillen sterk in zuurniveau: de ene komt uit een koel klimaat, de andere uit een warm klimaat met late oogst. Wat verklaar je hier als eerste?
...
Een wijn ruikt overwegend naar boter en toast, met weinig direct herkenbaar fruit. Wat is de meest waarschijnlijke verklaring, los van de druif zelf?
...
Blind: bleekgeel met groene rand, intense citrus- en kruidenaroma, hoog zuur, licht van lichaam, geen boter of toast. Welke combinatie van hypotheses past het beste?
...
Uitstekend. Je hebt kleur, aroma, zuur en MLF nu succesvol in één protocol geïntegreerd.

Drie leerankers:
- direct press als productiestartpunt zonder tannine-extractie
- zuur als structurele ruggengraat, belangrijker dan bij enige andere as
- MLF als belangrijkste stijlschakelaar tussen strak en rond

In les 16 zet je dit fundament om in druivenherkenning, te beginnen met de meest ondubbelzinnige aromatische druif: Sauvignon Blanc.
...
### Module 4 — Frisse witte druiven

**Level:** Specialist
**Framework pillar:** Druivenrassen
**Module goal:** In deze module leer je de belangrijkste frisse witte druiven herkennen, begrijpen en toepassen in proef- en pairingcontext.
...
Warme klimaatzone geeft vaak:

A. Meer tropisch fruit ✅
B. Minder fruit
C. Meer tannine
D. Minder zuur
...
Sauvignon Blanc is vaak:

A. Gastronomisch sterk ✅
B. Alleen dessert
C. Altijd houtgelagerd
D. Zoet
...
Sterk. Je herkent Sauvignon Blanc nu betrouwbaar op klimaat, aroma-intensiteit en kruidig-groene ondertoon.
...
In les 17 blijf je in aromatisch terrein, maar dan bij een druif die zelf juist neutraler is: Riesling.
...
Welke eigenschap hoort typisch bij Riesling?
...
Welke regio is klassiek voor Riesling?
...
Goed. Je begrijpt nu waarom Riesling geldt als de meest pure terroir-druif binnen de frisse categorie.

Drie leerankers:
- aromatische neutraliteit van de druif zelf, waardoor terroir sterker doorklinkt
- het brede zoetheidsspectrum van bloedstrak droog tot edelzoet
- TDN-petrolaroma als kwaliteitskenmerk bij rijping, geen fout

In les 18 verschuif je van Centraal-Europese terroirdruif naar een Atlantische, zilte stijl: Albariño.
...
Waar komt Albariño vooral vandaan?
...
Wat beïnvloedt Albariño sterk?

A. Atlantisch klimaat ✅
B. Woestijnklimaat
C. Hoogte
D. Hout
...
Sterk. Je herkent Albariño nu op zijn kenmerkende Atlantische, ziltige signatuur.
...
In les 19 verlaat je de kust en ontdek je een kruidige, continentale tegenhanger: Grüner Veltliner.
...
Waar komt Grüner Veltliner vandaan?
...
Een witte wijn combineert hoog zuur, groene appel en een duidelijke pepertoon in de afdronk. Welke druif past het beste, en waarop baseer je dat?
...
Goed. Je begrijpt nu hoe Grüner Veltliner zich onderscheidt van Riesling ondanks vergelijkbaar hoog zuur.

Drie leerankers:
- witte-pepertoon als unieke, herkenbare signatuur
- Steinfeder-tot-Smaragd als stijlbandbreedte binnen één druif
- grote dag-nachttemperatuurverschillen langs de Donau als zuurbehoudende factor

In les 20 sluit je Module 4 af met een Spaanse druif die op het eerste gezicht verrassend veel raakvlakken heeft: Verdejo.
...
Waar komt Verdejo vooral vandaan?
...
Je proeft een droge witte wijn met citrus, venkel en een lichte amandelbitterheid in de afdronk, minder aromatisch explosief dan een klassieke Marlborough-stijl. Welke druif ligt het meest voor de hand?
...
Sterk gedaan. Je sluit Module 4 af met een scherp onderscheid tussen drie vaak verwarde druiven.

Drie leerankers:
- amandelbitterheid als kenmerkend, onderscheidend signaal
- continentaal klimaat van Rueda als bron van frisheid én structuur
- Sauvignon Blanc en Albariño als de twee dichtstbijzijnde verwarringskandidaten

In Module 5 verschuif je van frisse naar rijke witte druiven, te beginnen in les 21 met Chardonnay — de druif die MLF, hout en sur lie het meest zichtbaar samenbrengt.
...
### Module 5 — Rijke witte druiven

**Level:** Specialist
**Framework pillar:** Druivenrassen
**Module goal:** In deze module leer je de belangrijkste rijke witte druiven herkennen, begrijpen en toepassen in proef- en pairingcontext.
...
Welke druif is het meest veelzijdig?
...
Goed — je herkent nu waarom Chardonnay de meest veelzijdige én meest misleidende witte druif is.

Drie leerankers:

- Chardonnay is zelf relatief neutraal; klimaat en wijnmaakkeuzes bepalen vrijwel de hele stijl.
- Houtrijping, bâtonnage en malolactische gisting voegen een onafhankelijke, herkenbare productielaag toe.
- Het grootste verwarringsgevaar is ongehoute Chardonnay tegenover Chenin Blanc — de zuurlijn beslist.

Volgende les: Les 22 laat zien hoe Chenin Blanc een nog bredere stijlbandbreedte combineert met een unieke zuur-en-body-combinatie.
...
Welke eigenschap hoort sterk bij Chenin Blanc?

A. Hoge zuren ✅
B. Hoge tannines
C. Lage aroma's
D. Geen bewaarpotentieel

### Vraag 2

Welke regio is beroemd voor Chenin Blanc?
...
Welke aroma's komen vaak voor?

A. Honing en appel ✅
B. Gras en paprika
C. Vanille en chocolade
D. Koffie en leer

### Vraag 5

Waarom rijpt Chenin goed?
...
Goed — je begrijpt nu waarom Chenin Blanc de breedste stijlbandbreedte van alle witte druiven heeft.

Drie leerankers:

- Chenin combineert hoog zuur mét body — een combinatie die zelden zo expliciet samen voorkomt.
- De Loire geeft precisie en mineraliteit; Zuid-Afrika geeft een rondere, fruitigere stijl.
- Tegenover Chardonnay behoudt Chenin vrijwel altijd een striktere, hogere zuurlijn.

Volgende les: Les 23 verschuift de focus naar Viognier, waar textuur zwaarder weegt dan zuur.
...
Welke aroma's zijn typisch voor Viognier?

A. Abrikoos en bloemen ✅
B. Gras en limoen
C. Petrol en appel
D. Chocolade en koffie
...
Goed — je herkent nu Viognier op zijn onmiskenbare florale abrikoosintensiteit en volle textuur.

Drie leerankers:

- Viognier heeft warmte nodig voor aroma, maar te veel warmte laat het toch al lage zuur wegvallen.
- Condrieu toont de meest geconcentreerde, parfumerige uitvoering van de druif.
- Het grootste verwarringsgevaar is Marsanne/Roussanne — Viognier is explicieter parfumerig-abrikoosachtig.

Volgende les: Les 24 behandelt Semillon, de druif die juist jong stil is en pas met rijping haar kracht toont.
...
Waar wordt Semillon veel gebruikt?
...
Semillon wordt vaak geblend met:
...
Welke stijl is beroemd met Semillon?
...
Wat ontwikkelt Semillon met rijping?
...
A. Structuur en rijpingspotentieel ✅
B. Hoge tannine
C. Koolzuur
D. Lage body
...
Goed — je begrijpt nu waarom Semillon een subtiele druif is met een uitzonderlijk rijpingspotentieel.

Drie leerankers:

- Jonge Semillon is wasachtig en stil, maar ontwikkelt met flesrijping honing, toast en noten.
- In Bordeaux levert Semillon body en rijpingscapaciteit in blends met Sauvignon Blanc.
- Botrytis maakt Semillon de ruggengraat van edelzoete Sauternes.

Volgende les: Les 25 sluit Module 5 af met Marsanne en Roussanne, twee Rhône-druiven die elkaar structureel aanvullen.
...
---
# LES 25 — Marsanne & Roussanne

## Metadata

**Slug:** marsanne-roussanne
**Duration:** 8 min
**Quiz questions:** 5
...
Een witte wijn heeft volle body, laag zuur, stone fruit en amandeltonen, maar mist de uitgesproken florale abrikooservaring die je bij een andere Rhône-druif zou verwachten. Welke druif(en) past/passen het beste?
...
- Samen vormen ze een wijn die noch te log noch te ijl wordt — vandaar de traditie van blenden.
- Het grootste verwarringsgevaar is Viognier, dat explicieter florale-abrikoosachtig is.

Volgende stap: Module 6 — Aromatische witte druiven, te beginnen met Gewürztraminer en zijn extreme terpeenconcentratie.
...
### Module 6 — Aromatische witte druiven

**Level:** Specialist
**Framework pillar:** Druivenrassen
**Module goal:** In deze module leer je de meest expressieve aromatische witte druiven herkennen, analyseren en toepassen in pairing en blindproeven.
...
Goed — je herkent nu Gewürztraminer op zijn extreme terpeenconcentratie en olieachtige textuur.

Drie leerankers:

- Linalool, geraniol en citronellol verklaren de intense lychee-rozen-gembersignatuur.
- Een lichte fenolische bitterheid geeft de kenmerkende olieachtige textuur — te veel is een kwaliteitsfout.
- Het onderscheid met Muscat zit vooral in textuur: olieachtig versus sappig-fris.

Volgende les: Les 27 verdiept in Muscat, de enige druivenfamilie die daadwerkelijk naar verse druiven ruikt.
...
Wat maakt Muscat uniek?

A. Het ruikt vaak letterlijk naar druiven ✅
B. Het heeft veel tannines
C. Het is altijd droog
D. Het is altijd houtgelagerd

### Vraag 2

Welke stijl kan Muscat zijn?
...
Welke wijn is een bekende Muscat?
...
Welke aroma's zijn typisch?

A. Sinaasappelbloesem en perzik ✅
B. Gras en kruisbes
C. Vanille en boter
D. Chocolade en koffie
...
- Muscat Blanc à Petits Grains, Alexandria en Ottonel delen terpenen maar verschillen in concentratie en stijl.
- Muscat is de enige grote druivenfamilie waarvan de wijn daadwerkelijk naar verse druiven ruikt.
- Terpeenvorming staat los van suiker of zuur — vandaar het brede stijlbereik van droog tot versterkt.

Volgende les: Les 28 behandelt Torrontés, waar hoogteligging en UV-stress een vergelijkbare terpeenrijkdom verklaren.
...
Waar komt Torrontés vooral vandaan?
...
Wat is typisch voor Torrontés?

A. Geur rijker dan smaak ✅
B. Meer tannine dan aroma
C. Altijd houtgelagerd
D. Altijd zoet

### Vraag 4

Welke aroma's zijn vaak aanwezig?
...
Goed — je herkent nu Torrontés op zijn florale intensiteit en het orthonasaal-retronasaal effect.

Drie leerankers:

- Torrontés Riojano is een natuurlijke kruising van Muscat of Alexandria en Criolla Chica.
- 'Geur rijker dan smaak' is orthonasale waarneming die terpenen sterker registreert dan retronasale waarneming.
- Extreme hoogte in Salta en Cafayate behoudt zuur ondanks intense zoninstraling.

Volgende les: Les 29 verschuift naar Pinot Gris, een druif die minder terpenerijk is en meer op textuur leunt.
...
Zijn Pinot Gris en Pinot Grigio dezelfde druif?
...
Waar is Pinot Gris vaak rijker?
...
Goed — je begrijpt nu dat Pinot Gris en Pinot Grigio dezelfde druif zijn met twee stijltradities.

Drie leerankers:

- De druif zelf is slechts matig terpenerijk — karakter komt vaak van schilcontact, niet van primaire aromatiek.
- Italië perst direct en licht; Alsace macereert langer voor een rijkere, kruidigere stijl.
- Blindherkenning steunt op een structurele tussenpositie tussen fris en rijk, niet op één signatuuraroma.

Volgende les: Les 30 sluit Module 6 af met Vermentino, dat 'fris' en 'aromatisch' bewust overbrugt.
...
Waar komt Vermentino veel voor?
...
Hoe heet Vermentino in Zuid-Frankrijk?
...
Volgende stap: Module 7 — Service, te beginnen met hoe serveertemperatuur aroma direct stuurt.
...
**Module goal:** In deze module leer je hoe witte wijn professioneel wordt geserveerd, bewaard en gepresenteerd.
...
Sauvignon Blanc serveer je meestal:
...
Goed — je begrijpt nu waarom serveertemperatuur rechtstreeks samenhangt met aromavolatiliteit.

Drie leerankers:

- Te koud onderdrukt de verdamping van terpenen — juist een risico bij aromatische witte wijn.
- Gist- en houtgelagerde textuur is temperatuurgevoelig, vandaar het bewust warmer serveren van top-Bourgogne.
- Overmatig koelen kan lichte oxidatie of hitteschade maskeren — wees daar professioneel alert op.

Volgende les: Les 32 bouwt hierop voort met glaswerk, dat dezelfde aromatische verbindingen op een andere manier stuurt.
...
Een smaller glas helpt vaak bij:

A. Meer zuurstof
B. Meer frisheid behouden ✅
C. Meer warmte
D. Minder aroma

### Vraag 3

Een breder glas helpt vaak bij:

A. Complexe aroma's openen ✅
B. Minder geur
C. Minder body
D. Minder zuur
...
Welke wijn krijgt vaak een breder glas?
...
- Smalle glazen concentreren terpenen en beperken alcoholwaarneming bij aromatische witte wijn.
- Brede kelken geven textuurgedreven, houtgelagerde witte wijn ruimte om zich te ontplooien.
- Detergent-residu dempt topnoten — kritiek bij aroma-gedreven aromatische witte wijn.

Volgende les: Les 33 behandelt decanteren, waar witte wijn een ander mechanisme volgt dan rood: reductie.
...
Is decanteren alleen voor rode wijn?
...
Waarom decanteer je witte wijn soms?

A. Meer kleur
B. Om reductie te openen ✅
C. Minder zuur
D. Meer suiker

### Vraag 3

Welke wijn profiteert vaak?

A. Oude Riesling ✅
B. Jonge Verdejo
C. Jonge Pinot Grigio
D. Moscato
...
Goed — je begrijpt nu dat decanteren bij witte wijn meestal om reductie draait, niet om sediment.

Drie leerankers:

- Vluchtige zwavelverbindingen verdampen bij kort zwenken — een echt gebrek doet dat niet.
- Oude Riesling, rijke witte Bourgogne en Chenin Blanc profiteren het meest van decanteren.
- Splash-decanteren lost snel reductie op; langzaam decanteren dient structurele ontwikkeling.

Volgende les: Les 34 sluit Module 7 af met bewaren en rijping, waar dezelfde fragiliteit een grotere rol speelt.
...
---
# LES 34 — Bewaren & rijping

## Metadata

**Slug:** bewaren-en-rijping
**Duration:** 8 min
**Quiz questions:** 5
...
Volgende stap: Module 8 — Pairing & Gastronomie, te beginnen met het chemische mechanisme achter witte wijn en vis.
...
**Module goal:** In deze module leer je witte wijn professioneel combineren met gerechten en begrijp je waarom bepaalde combinaties werken.
...
Goed — je begrijpt nu het chemische mechanisme achter waarom witte wijn zo sterk werkt met vis.
...
Volgende les: Les 36 past dezelfde mechanismen toe op kaas, waar zuur-vet-snede het dominante principe wordt.
...
Waarom werkt witte wijn vaak goed met kaas?
...
Wat doen zuren bij vet?

A. Verzwaren
B. Snijden erdoorheen ✅
C. Maken zoeter
D. Verlagen aroma

### Vraag 3

Welke wijn past goed bij geitenkaas?
...
Welke combinatie is logisch?

A. Brie + Chardonnay ✅
B. Brie + Riesling droog
C. Brie + Port
D. Brie + Tawny
...
- Zuur-vet-snede is het dominante mechanisme bij wit en kaas, in plaats van vet-tannine-binding.
...
Volgende les: Les 37 verschuift naar gevogelte, waar saus en bereiding de wijnkeuze sterker sturen dan het vlees zelf.
...
---
# LES 37 — Witte wijn & gevogelte

## Metadata

**Slug:** witte-wijn-gevogelte
**Duration:** 8 min
**Quiz questions:** 5
...
- Dezelfde sausgedreven logica is overdraagbaar naar romige of pittige vegetarische gerechten.

Volgende stap: Module 9 — Blindproeven & Examen, te beginnen met Sauvignon Blanc versus Riesling.
...
**Module goal:** In deze module leer je witte wijn blind analyseren, druiven herkennen en alle opgedane kennis integreren in een praktijk- en theorie-examen.
...
**Slug:** sauvignon-vs-riesling-blind
**Duration:** 10 min
**Quiz questions:** 5
...
Welke druif geeft vaak kruisbes?
...
Goed — je begrijpt nu de belangrijkste blindverschillen tussen Sauvignon Blanc en Riesling.

Drie leerankers:

- Methoxypyrazines geven Sauvignon Blanc groene paprika en kruisbes; monoterpenen geven Riesling floraal-limoen.
- 'Sauvignon Blanc' heeft zelf twee chemisch verschillende drijfveren: methoxypyrazines versus vluchtige thiolen.
- Structuur eerst, label laatst — fenolische grip is vaak het beslissende signaal.

Volgende les: Les 39 past dezelfde structuur-eerst-aanpak toe op Chardonnay versus Chenin Blanc.
...
**Slug:** chardonnay-vs-chenin-blind
**Duration:** 10 min
**Quiz questions:** 5
...
Wat is vaak het sleutelverschil?
...
Goed — je begrijpt nu het sleutelverschil tussen Chardonnay en Chenin Blanc in een blindproef.

Drie leerankers:

- 'Chardonnaysmaak' (boter, vanille, toast) is grotendeels een winemaking-signatuur, geen varietale eigenschap.
- Chenin Blanc behoudt van nature hoge zuren, ongeacht rijpheid of stijl.
- Proef eerst de zuurstructuur, interpreteer winemaking-signalen zoals hout en boter pas daarna.

Volgende les: Les 40 — het Theorie- en praktijkexamen — integreert alle veertig lessen in één Master-toets.
...
Gefeliciteerd — je beheerst nu het volledige fundament van witte wijn: theorie, productie, druivenkennis, service, pairing en blindproeven.

Drie leerankers:

- Drie druivenfamilies (fris, rijk, aromatisch) drijven elk op een ander mechanisme — primair fruit, winemaking-textuur of terpeenchemie.
...
Volgende stap: kies je vervolgtrack — Rosé, Rood, Mousserend, Port of Cocktails — en bouw voort op deze Master-basis.
