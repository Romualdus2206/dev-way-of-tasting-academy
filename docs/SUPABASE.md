...
| `supabase/migrations/20260626140000_academy_lessons_key_concepts.sql` | Kolom `key_concepts_markdown` op `lessons` |
| `supabase/migrations/20260626150000_academy_practice_progress.sql` | Praktijk-checklist voortgang |
