...
MODULE_REGISTRY: dict[int, dict[str, str]] = {
    ...
    2: {"slug": "productie-beer", "title": "Productie", "level": "explorer"},
    3: {"slug": "proeven-beer", "title": "Proeven", "level": "explorer"},
    4: {"slug": "klassieke-stijlen-beer", "title": "Klassieke stijlen", "level": "specialist"},
    5: {"slug": "belgische-stijlen-beer", "title": "Belgische stijlen", "level": "specialist"},
    6: {"slug": "moderne-stijlen-beer", "title": "Moderne stijlen", "level": "specialist"},
    7: {"slug": "service-beer", "title": "Service", "level": "master"},
    8: {"slug": "pairing-beer", "title": "Pairing & Gastronomie", "level": "master"},
    9: {"slug": "examen-beer", "title": "Blindproeven & Examen", "level": "master"},
}
...
def split_bier_modules(text: str) -> list[str]:
    parts = re.split(r"(?=\n### Module \d+ — )", text)
...
"""
    ...
    seed_path = ROOT / "supabase/seed/academy_beer.sql"
