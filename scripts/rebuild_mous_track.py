#!/usr/bin/env python3
"""Rebuild supabase/seed/academy_sparkling.sql from content/MOUS_FINAL_CONTENT.md."""
...
TRACK_SLUG = "sparkling"
SOURCE_FALLBACKS = (
    ROOT / "content/MOUS_FINAL_CONTENT.md",
    ROOT / "content/pipeline/MOUS_LOCKED_CONTENT.md",
    ROOT / "content/pipeline/MOUS_PIPELINE_CONTENT.md",
    ROOT / "content/archive/legacy/MOUS_MODULES.md",
)

MODULE_REGISTRY: dict[int, dict[str, str]] = {
    1: {"slug": "intro-sparkling", "title": "Fundament", "level": "explorer"},
    2: {"slug": "productie-sparkling", "title": "Productie", "level": "explorer"},
    3: {"slug": "proeven-sparkling", "title": "Proeven", "level": "explorer"},
    4: {"slug": "champagne-sparkling", "title": "Champagne", "level": "specialist"},
    5: {"slug": "wereldstijlen-sparkling", "title": "Wereldstijlen", "level": "specialist"},
    6: {"slug": "suiker-stijl-sparkling", "title": "Suiker & Stijl", "level": "specialist"},
    7: {"slug": "service-sparkling", "title": "Service", "level": "master"},
    8: {"slug": "pairing-sparkling", "title": "Pairing & Gastronomie", "level": "master"},
    9: {"slug": "examen-sparkling", "title": "Blindproeven & Examen", "level": "master"},
}
...
def rebuild() -> None:
    ...
    modules_text = split_mous_modules(source.read_text(encoding="utf-8"))
    ...
    header = f"""-- Sparkling / Mousserend track seed (na 20260625140000_academy_v1_tracks.sql)
...
"""
    ...
    seed_path = ROOT / "supabase/seed/academy_sparkling.sql"
