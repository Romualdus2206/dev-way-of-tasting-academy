#!/usr/bin/env python3
"""Rebuild supabase/seed/academy_beer_zero.sql from content/BIER_0_0_FINAL_CONTENT.md."""
...
TRACK_SLUG = "beer-zero"
SOURCE_FALLBACKS = (
    ROOT / "content/BIER_0_0_FINAL_CONTENT.md",
    ROOT / "content/pipeline/BIER_0_0_PIPELINE_CONTENT.md",
    ROOT / "content/archive/legacy/BIER_0_0_MODULES.md",
)

MODULE_REGISTRY: dict[int, dict[str, str]] = {
    1: {"slug": "intro-beer-zero", "title": "Fundament", "level": "explorer"},
    2: {"slug": "productie-beer-zero", "title": "Productie", "level": "explorer"},
    3: {"slug": "proeven-beer-zero", "title": "Proeven", "level": "explorer"},
    4: {"slug": "klassieke-stijlen-beer-zero", "title": "Klassieke stijlen", "level": "specialist"},
    5: {"slug": "markt-innovatie-beer-zero", "title": "Markt & Innovatie", "level": "specialist"},
    6: {"slug": "gezondheid-beer-zero", "title": "Gezondheid & Lifestyle", "level": "specialist"},
    7: {"slug": "service-beer-zero", "title": "Service", "level": "master"},
    8: {"slug": "pairing-beer-zero", "title": "Pairing & Gastronomie", "level": "master"},
    9: {"slug": "examen-beer-zero", "title": "Blindproeven & Examen", "level": "master"},
}
...
def rebuild() -> None:
    ...
    modules_text = split_beer_zero_modules(source.read_text(encoding="utf-8"))
    ...
    header = f"""-- Bier 0.0 track seed (na 20260625140000_academy_v1_tracks.sql)
...
"""
    ...
    seed_path = ROOT / "supabase/seed/academy_beer_zero.sql"
