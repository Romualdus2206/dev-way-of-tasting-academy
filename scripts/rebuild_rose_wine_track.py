#!/usr/bin/env python3
"""Rebuild supabase/seed/academy_rose_wine.sql from Rosé track Gold Master (LOCKED preferred)."""
...
TRACK_SLUG = "rose-wine"
SOURCE_FALLBACKS = (
    ROOT / "content/ROSE_FINAL_CONTENT.md",
    ROOT / "content/pipeline/ROSE_PIPELINE_CONTENT.md",
    ROOT / "content/archive/legacy/ROSE_MODULES.md",
)

MODULE_REGISTRY: dict[int, dict[str, str]] = {
    1: {"slug": "intro-rose-wine", "title": "Fundament", "level": "explorer"},
    2: {"slug": "productie-rose-wine", "title": "Productie", "level": "explorer"},
    3: {"slug": "proeven-rose-wine", "title": "Proeven", "level": "explorer"},
    4: {"slug": "klassieke-stijlen-rose-wine", "title": "Klassieke stijlen", "level": "specialist"},
    5: {"slug": "druivenrassen-rose-wine", "title": "Druivenrassen", "level": "specialist"},
    6: {"slug": "stijl-gastronomie-rose-wine", "title": "Stijl & Gastronomie", "level": "specialist"},
    7: {"slug": "service-rose-wine", "title": "Service", "level": "master"},
    8: {"slug": "pairing-rose-wine", "title": "Pairing & Gastronomie", "level": "master"},
    9: {"slug": "examen-rose-wine", "title": "Blindproeven & Examen", "level": "master"},
}
...
def rebuild() -> None:
    ...
    modules_text = split_rose_modules(source.read_text(encoding="utf-8"))
    ...
    header = f"""-- Rosé Wine track seed (na 20260625140000_academy_v1_tracks.sql)
...
"""
    ...
    seed_path = ROOT / "supabase/seed/academy_rose_wine.sql"
