...
MODULE_REGISTRY: dict[int, dict[str, str]] = {
    ...
    2: {"slug": "productie-red-wine", "title": "Productie", "level": "explorer"},
    3: {"slug": "proeven-red-wine", "title": "Proeven", "level": "explorer"},
    4: {"slug": "lichte-druiven-red-wine", "title": "Lichte rode druiven", "level": "specialist"},
    5: {"slug": "medium-druiven-red-wine", "title": "Medium body druiven", "level": "specialist"},
    6: {"slug": "krachtige-druiven-red-wine", "title": "Krachtige rode druiven", "level": "specialist"},
    7: {"slug": "service-red-wine", "title": "Service", "level": "master"},
    8: {"slug": "pairing-red-wine", "title": "Pairing & Gastronomie", "level": "master"},
    9: {"slug": "examen-red-wine", "title": "Blindproeven & Examen", "level": "master"},
}
...
def rebuild() -> None:
    ...
    header = f"""-- Red Wine track seed (na 20260625140000_academy_v1_tracks.sql)
...
"""
    ...
    seed_path = ROOT / "supabase/seed/academy_red_wine.sql"
