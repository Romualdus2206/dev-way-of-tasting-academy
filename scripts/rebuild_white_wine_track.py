#!/usr/bin/env python3
"""Rebuild supabase/seed/academy_white_wine.sql from content/pipeline/WHITE_PIPELINE_CONTENT.md."""
...
TRACK_SLUG = "white-wine"
SOURCE_FALLBACKS = (
    ROOT / "content/WHITE_FINAL_CONTENT.md",
    ROOT / "content/pipeline/WHITE_PIPELINE_CONTENT.md",
    ROOT / "content/archive/legacy/WIT_MODULES.md",
)

MODULE_REGISTRY: dict[int, dict[str, str]] = {
    1: {"slug": "intro-white-wine", "title": "Fundament", "level": "explorer"},
    2: {"slug": "productie-white-wine", "title": "Productie", "level": "explorer"},
    3: {"slug": "proeven-white-wine", "title": "Proeven", "level": "explorer"},
    4: {"slug": "frisse-druiven-white-wine", "title": "Frisse witte druiven", "level": "specialist"},
    5: {"slug": "rijke-druiven-white-wine", "title": "Rijke witte druiven", "level": "specialist"},
    6: {"slug": "aromatische-druiven-white-wine", "title": "Aromatische witte druiven", "level": "specialist"},
    7: {"slug": "service-white-wine", "title": "Service", "level": "master"},
    8: {"slug": "pairing-white-wine", "title": "Pairing & Gastronomie", "level": "master"},
    9: {"slug": "examen-white-wine", "title": "Blindproeven & Examen", "level": "master"},
}
...
def rebuild() -> None:
    ...
    modules_text = split_white_modules(source.read_text(encoding="utf-8"))
    ...
    header = f"""-- White Wine track seed (na 20260625140000_academy_v1_tracks.sql)
...
"""
    ...
    seed_path = ROOT / "supabase/seed/academy_white_wine.sql"
