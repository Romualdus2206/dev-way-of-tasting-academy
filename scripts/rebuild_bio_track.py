...
MODULE_REGISTRY: dict[int, dict[str, str]] = {
    ...
    2: {"slug": "kalender-biodynamic", "title": "De kalender begrijpen", "level": "explorer"},
    3: {"slug": "proeven-biodynamic", "title": "Proeven per dagtype", "level": "explorer"},
    4: {"slug": "weer-biodynamic", "title": "Weer & atmosfeer", "level": "specialist"},
    5: {"slug": "stijlen-biodynamic", "title": "Wijnstijlen & dagtypes", "level": "specialist"},
    6: {"slug": "cross-biodynamic", "title": "Bier, cocktails & 0.0", "level": "specialist"},
    7: {"slug": "voorraad-biodynamic", "title": "Voorraad & drinkstrategie", "level": "master"},
    8: {"slug": "intelligence-biodynamic", "title": "Persoonlijke tasting intelligence", "level": "master"},
    9: {"slug": "examen-biodynamic", "title": "Praktijkexamen", "level": "master"},
}
...
def rebuild() -> None:
    ...
    header = f"""-- Biodynamisch Proeven track seed (na 20260625140000_academy_v1_tracks.sql)
...
"""
    ...
    seed_path = ROOT / "supabase/seed/academy_biodynamic.sql"
